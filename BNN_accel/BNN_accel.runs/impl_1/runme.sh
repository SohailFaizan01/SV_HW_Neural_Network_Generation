...
HD_PWD='C:/Users/Sohai/Desktop/Academics/TU_Delft/Q4/EE4690_Hardware_Architecture_for_AI/EE4690_Hardware_Architecture_for_AI/BNN_accel/BNN_accel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BNN_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BNN_wrapper.tcl -notrace
