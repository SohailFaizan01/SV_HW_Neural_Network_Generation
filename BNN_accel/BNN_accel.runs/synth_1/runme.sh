...
HD_PWD='C:/Users/Sohai/Desktop/Academics/TU_Delft/Q4/EE4690_Hardware_Architecture_for_AI/EE4690_Hardware_Architecture_for_AI/BNN_accel/BNN_accel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BNN_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BNN_wrapper.tcl
